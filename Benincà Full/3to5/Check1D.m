...
for i = 1:1
    ...
    scatter(trans_tmp(loca_pos,1),trans_tmp(loca_pos,2),'MarkerFaceColor','b','MarkerEdgeColor','b','MarkerFaceAlpha',alpha,'MarkerEdgeAlpha',0.05)
    hold on
    scatter(trans_tmp(loca_neg,1),trans_tmp(loca_neg,2),'MarkerFaceColor','r','MarkerEdgeColor','r','MarkerFaceAlpha',alpha,'MarkerEdgeAlpha',0.05)
    hold on
