...
% data_ori = [data_ori.Rotifers, data_ori.Cyclopoids, data_ori.Picophytoplankton, data_ori.Nanophytoplankton];
% labels = ["Rotifers", "Cyclopoids", "Picophytoplankton", "Nanophytoplankton"];
