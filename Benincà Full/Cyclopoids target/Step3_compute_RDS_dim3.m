...
filename = 'RDS_dim3';
save(filename, 'S_total_list', 'L_total_list','component_list_dim3', 'num_component', 'num_pair','num_type','num_data')

delete(gcp('nocreate'))

plot_RDS_heatmap(dimension, component_list_dim3, S_total_list, labels);
