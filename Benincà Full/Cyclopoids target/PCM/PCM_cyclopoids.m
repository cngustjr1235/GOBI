...
for i=1:N
    for j=1:N
        ...
        [PPC2(i,j),PV2(i,j)]=corr(CX(:,mid,i,j),CY(:,i,j));
        time_series_corr(i,j) = corr(y_linear(:,i), y_linear(:,j));
    end
end


save(filename, 'PV','PPC', 'PV2', 'PPC2', 'time_series_corr');