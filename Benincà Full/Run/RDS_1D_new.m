function [S_total_list, R_total_list, pair_list] = RDS_1D_new(y_total, t_total, target, num_component, type_self, thres_noise)
...
parfor data = 1:num_data
    ...
    for pair = 1:length(pair_list(:,1))
        ...
        if type_self == -1
            [score_list, t_1, t_2] = RDS_ns_dim1(y(:,cause1_index), y(:,target_index), t, nan);
        elseif type_self == 1
            [score_list, t_1, t_2] = RDS_ps_dim1(y(:,cause1_index), y(:,target_index), t, nan);
        else
            [score_list, t_1, t_2] = RDS_dim1(y(:,cause1_index), y(:,target_index), t, nan);
        end
