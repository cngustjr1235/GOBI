function [S_total_list, R_total_list, pair_list] = RDS_2D(y_total, t, fixed_target, num_component, type_self, time_interval, thres_noise)
...
parfor data = 1:num_data
    ...
    for pair = 1:length(pair_list(:,1))
        ...
        if type_self == -1
            [score_list, t_1, t_2] = RDS_ns_dim2(y(:,cause1_index), y(:,cause2_index), y(:,target_index), t, time_interval);
        elseif type_self == 1
            [score_list, t_1, t_2] = RDS_ps_dim2(y(:,cause1_index), y(:,cause2_index), y(:,target_index), t, time_interval);
        else
            [score_list, t_1, t_2] = RDS_dim2(y(:,cause1_index), y(:,cause2_index), y(:,target_index), t, time_interval);
        end
