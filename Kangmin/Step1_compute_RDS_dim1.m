...
filename = 'RDS_dim1';
save(filename, 'S_total_list', 'L_total_list','component_list_dim1', 'num_component', 'num_pair','num_type','num_data', 'labels', 'y')


%% plot heatmap

[Ssorted, I] = sortrows(component_list_dim1, 2);
S_sort_total = S_total_list;
for i = 1:2^dimension
    col = S_sort_total(:, i);
    S_sort_total(:,i) = col(I);
end
plot_RDS_heatmap(dimension, Ssorted, S_sort_total, labels);
