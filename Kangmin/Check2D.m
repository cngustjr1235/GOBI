...
%% parameter
st1 = 2; % choose the first causal variable
st2 = 3; % choose the second causal variable
ed = 1;  % choose the target variable
type = 1;
...
for i = 1:num_data
    ...
    scatter(trans_tmp(loca_pos,1),trans_tmp(loca_pos,2),'SizeData', 1,'MarkerFaceColor','b','MarkerEdgeColor','b','MarkerFaceAlpha',alpha,'MarkerEdgeAlpha',alpha)
    hold on
    scatter(trans_tmp(loca_neg,1),trans_tmp(loca_neg,2),'SizeData', 1,'MarkerFaceColor','r','MarkerEdgeColor','r','MarkerFaceAlpha',alpha,'MarkerEdgeAlpha',alpha)
    hold on
