...
% cardio/resp/no2/so2/rspar/o3/temp/hum

%% moving average of cardio
win_avg = 7;
 
y_tmp = y(:,1);
y(:,1) = movmean(y_tmp, win_avg);
...
window_size_ori = 365;     % For oscillatory data, 1 period is recommended
overlapping_ratio = 11/12;  % overlapping ratio of moving window technique
